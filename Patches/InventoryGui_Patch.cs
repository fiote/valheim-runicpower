        ...
        public static class InventoryGui_Awake_Patch {
            ...
            public static class InventoryGui_UpdateInventory_Patch {
                public static void Postfix(InventoryGui __instance, Player player) {
                    var spellsBarInventory = player.GetSpellsBarInventory();
                    if (spellsBarInventory != null) SpellsBarGrid.UpdateInventory(spellsBarInventory, player, __instance.m_dragItem);
                }
            }
        }
    }
